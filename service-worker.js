const CACHE='salmos-pwa-v19';
const CORE=['/','/index.html','/styles.css?v=19.0','/app.js?v=19.0','/config.js','/icon-192.png','/icon-512.png','/logo-mark.png','/banner-salmos-header.png','/manifest.webmanifest'];
