const CACHE='salmos-pwa-v23';
const CORE=['/','/index.html','/styles.css?v=23.0','/app.js?v=23.0','/config.js','/icon-192.png','/icon-512.png','/logo-mark.png','/banner-salmos-header.png','/banner-salmos-light.png','/manifest.webmanifest'];
