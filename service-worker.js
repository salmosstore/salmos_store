const CACHE='salmos-pwa-v9-1';
const CORE=['/','/index.html','/styles.css?v=9.1','/app.js?v=9.1','/config.js','/icon-192.png','/icon-512.png','/logo-mark.png','/banner-salmos-header.png','/manifest.webmanifest'];
