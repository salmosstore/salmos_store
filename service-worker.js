const CACHE='salmos-pwa-v16';
const CORE=['/','/index.html','/styles.css?v=16.0','/app.js?v=16.0','/config.js','/icon-192.png','/icon-512.png','/logo-mark.png','/banner-salmos-header.png','/manifest.webmanifest'];
