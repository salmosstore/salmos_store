const CACHE='salmos-pwa-v8-0';
const CORE=['/','/index.html','/styles.css?v=8.0','/app.js?v=8.0','/config.js','/icon-192.png','/icon-512.png','/logo-mark.png','/banner-salmos-header.png','/manifest.webmanifest'];
