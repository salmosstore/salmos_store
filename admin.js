(() => {
  ...
  const titles={dashboard:'Dashboard',products:'Productos',orders:'Órdenes',customOrders:'Pedidos',stock:'Stock',coupons:'Cupones',categories:'Categorías',expenses:'Caja',flyers:'Flyers',settings:'Configuración'};
  ...
  async function renderProducts(){
    ...
    qs('#adminContent').innerHTML=`
      ...
      <div class="notice compact-admin-note">Orden de la tienda: arrastrá desde ☰ con el mouse o el dedo. Se guarda al soltar.</div>
  ...
  async function renderStock(){
    ...
    qs('#adminContent').innerHTML=`
      ...
      <div class="admin-card admin-table-wrap"><table class="admin-table"><thead><tr><th>Producto</th><th>Color</th><th>Talle</th><th>Corte</th><th>Género</th><th>Preparación</th><th>Stock físico</th><th>Disponible</th><th></th></tr></thead><tbody id="stockTableBody"></tbody></table></div>`;
    renderStockFiltered();
  }
